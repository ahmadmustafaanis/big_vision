...
def fix_old_checkpoints(params):
    ...
    print("Params['img'] keys are: ", params["img"].keys())
    print(
        "params['img']['Transformer'] keys are: ", params["img"]["Transformer"].keys()
    )
    # Original ViT paper variant had posemb in a module:
    if "posembed_input" in params["img"]:
    ...
    if "pos_embedding" in params["img"]:
        print("Pos Embeddings are there")
